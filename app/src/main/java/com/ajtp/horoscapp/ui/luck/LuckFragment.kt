package com.ajtp.horoscapp.ui.luck
...
import com.ajtp.horoscapp.databinding.FragmentLuckBinding
import com.ajtp.horoscapp.ui.providers.RandomCardProvider
...
class LuckFragment : Fragment() {
    ...
    private fun preparePrediction() {
        ...
        luck?.let {luck ->
            val currentLuck = getString(luck.text)
            binding.tvLucky.text = currentLuck
            binding.ivLuckyCard.setImageResource(luck.image)
            binding.tvShare.setOnClickListener{
                shareResult(currentLuck)
            }
        }
    }
